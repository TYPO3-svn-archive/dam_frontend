		...
		$cObj = t3lib_div::makeInstance('tslib_cObj');
 		foreach ($list as $elem) {
			...
			if ($useRequestForm==1 && $elem['tx_damfrontend_use_request_form'] == 1) {
				...
				$urlDownload = $cObj->getTypoLink_URL($GLOBALS['TSFE']->id, array('eID' => 'dam_frontend_push','docID' => $elem['uid']));
				$markerArray['###LINK_DOWNLOAD###'] = '<a href="'.$urlDownload.'" ><img src="'.$this->iconPath.'clip_pasteafter.gif" style="border-width: 0px"/></a>';
	 		}
