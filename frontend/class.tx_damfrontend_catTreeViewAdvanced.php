...
class tx_damfrontend_catTreeViewAdvanced extends tx_dam_selectionCategory {
	 ...
	 *
	 * @param	[int]		$catUID ID of the category
	...
	function filelist($catID, $treeLevelCSS) {
		...
		if (!empty($files)) {
			...
			if ($this->conf['explorerViewElements.']['useAlternatingRows'] == 1) {
				...
				if (!isset($this->conf['explorerViewElements.']['marker.']['filelist_record'])) {
					$this->conf['explorerViewElements.']['marker.']['filelist_record'] = '###FILELIST_RECORD###';
				}
