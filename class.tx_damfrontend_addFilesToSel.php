...
/**
 * Class/Function which manipulates the item-array for the pi2 template
 * selector in the flexform.
 *
 * @author    Ingo Renner <typo3@ingo-renner.com>
 * @author    Marcus Schwemer <marcus.schwemer@in2code.de>
 */
class tx_damfrontend_addfilestosel {
	...
	function main(&$params, &$pObj) {
		...
		$readPath = t3lib_div::getFileAbsFileName(
			$template->setup['plugin.']['tx_damfrontend_pi2.']['templatePath']
		);
