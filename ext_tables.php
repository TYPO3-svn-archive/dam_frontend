...
$tempColumns = Array (
	...
	"tx_damfrontend_uses3" => Array (
		"exclude" => 1,
		"label" => "LLL:EXT:dam_frontend/locallang_tca.php:tx_damfrontend_uses3",
		"config" => Array (
			"type" => "check",
		),
	),
	"tx_damfrontend_s3" => Array (
		"exclude" => 1,
		"label" => "LLL:EXT:dam_frontend/locallang_tca.php:tx_damfrontend_s3",
		"config" => Array (
			"type" => "input",
			"size" => 60,
		),
...
t3lib_extMgm::addToAllTCAtypes("tx_dam","tx_damfrontend_uses3, tx_damfrontend_s3",'','after:meta');
